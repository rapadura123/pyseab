...
# Data: 07/03/2013
# Última Modificação: 25/03/2013 - 3,7
# -- (considerar ultimo posicao da string, verificar: antecessores e
# --   sucessores, método novo )
# Python 3.2.3 - Linux, Ubuntu 32 bit. 12.10
# -------------------------------------------------------------
#                       Implementações:
...
class Simp( object ):
  ...
  def __init__( self, exp ):
    ...
    self.alf2 = { 'X':{'X':'00' ,'.':'11' ,'+':'11' ,'~':'10' , '(':'10' ,')':'01'},
                 '.':{'X':'11' ,'.':'00' ,'+':'00' ,'~':'01' , '(':'01' ,')':'10'},
                 '+':{'X':'11' ,'.':'00' ,'+':'00' ,'~':'01' , '(':'11' ,')':'00'},
                 '~':{'X':'01' ,'.':'00' ,'+':'10' ,'~':'11' , '(':'11' ,')':'00'},
                 '(':{'X':'01' ,'.':'10' ,'+':'10' ,'~':'01' , '(':'11' ,')':'00'},
...
if __name__ == '__main__':
  ...
  print(' - PySeab - Simplificador de Expressões Algébricas Booleanas - jpbanczek@gmail.com | 2013\n')
  x = input(": ")
  s = Simp(x)
  print(math.e)
  print(scipy.could)
